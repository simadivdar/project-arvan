<template>
    ...
    <div class="row gy-5 d-flex justify-content-around">
        <div class="col-6"><h2 class="py-4">All Posts</h2></div>
        <div  class="col-6">
        ...
        <div v-else>
            ...
            <nav aria-label="Page navigation example" class="d-flex justify-content-center mt-5">
                <ul class="pagination  pagination-lg" >
                    <li class="page-item">
                        <router-link class="page-link" @click="setPage(1)"  :to="{ name:'PagesPosts-' ,  params: { page: 1 }}" aria-label="Previous">
                            <span aria-hidden="true" >&laquo;</span>
                        </router-link>
                    </li>
                    <li class="page-item" v-for="page,index in pageNumber" :key="index" >
                        <router-link class="page-link" @click="setPage(page)" :to="{ name:'PagesPosts-' ,  params: { page: page }}">
                            {{ page }}
                        </router-link>
                    </li>
                    <li class="page-item">
                        <router-link class="page-link"  @click="setPage(2)" :to="{ name:'PagesPosts-' ,  params: { page: 2 }}" aria-label="Next">
...
import {setSHow,setPosts,setPage, textSHow} from "@/services/Postservice.js"
export default {
    name : 'showarticels-',
    components:{
        Table
