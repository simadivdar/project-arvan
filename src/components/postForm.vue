    ...
    <form @submit.prevent="validate" class="px-4 ">
      <div class="row d-flex ">
        ...
        <div>
          ...
          <input type="text" class="form-control" placeholder="Title" v-model.lazy.trim="form.article.title" />
        ...
        <div>
          ...
          <input type="text" class="form-control" placeholder="Description" v-model.lazy.trim="form.article.description" />
          <div class="form-text text-danger">
        ...
        <div class="px-4">
          ...
          <input  type="text"  class="form-control" placeholder="New tag"  v-model.lazy.trim="form.article.tagList" style="width:250px;"/>
          <div class="form-text text-danger">
            {{ errorText.tagListErrorText }}
          </div>
          <div class="border border-success py-4  border-opacity-25 rounded" style="width:250px;">
            <div v-for="(tag,index) in sortedArray() " :key="index" class="form-check">
              <input class="form-check-input bg-light ms-1" type="checkbox" :value="tag" v-model="listTags"  id=tag>
      ...
      <div class="row py-4">
      <button type="submit" class="btn btn-primary col-auto" :disabled="buttonLoading">
        <div
          v-if="buttonLoading"
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      function validate() {
        ...
        if (form.article.title !== "" && form.article.body !== "" && form.article.description !== "" && form.article.tagList !== "") {
          form.article.tagList=listTags.value;
          emit("formData", form);
        }
      }
