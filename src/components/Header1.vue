<template>
      <header>
        ...
        <nav class="navbar navbar-expand-sm bg-dark bg-body-white w-100" style="height: 60px;">
            ...
            <div class="col-2 col-md-1   col-ms-auto collapse navbar-collapse" id="navbarSupportedContent">
